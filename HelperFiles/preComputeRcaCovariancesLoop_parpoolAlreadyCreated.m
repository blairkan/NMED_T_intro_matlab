function [sumXX,sumYY,sumXY,nPointsInXX,nPointsInYY,nPointsInXY]=preComputeRcaCovariancesLoop_parpoolAlreadyCreated(data,condRange,subjRange)
...
for cond=1:nCond
    for subj=1:nSubjects
        ...
        if nTrials>=20 % BK changed from 30 to 20
            disp([num2str(nTrials) ' trials: Using ``for'' loop.'])
