function [dataOut,W,A,Rxx,Ryy,Rxy,dGen,h] = rcaRun125_parpoolAlready2021(data,nReg,nComp,condRange,subjRange,show,locfile)
...
% Customized for 125-channel montage
if nargin<7 || isempty(locfile)
    % Custom - not in main RCA repo
    locfile='Hydrocel GSN 128 1.0.sfp';
    locs = readlocs(locfile);
    locs = locs([4:127 132]); % This is the 125 electrodes
end;
